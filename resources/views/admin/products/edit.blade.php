                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="checkbox" name="featured"  value="{{$product->featured=='1' ? 'checked':''}}" style="width: 20px;height: 20px;"  />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <label>Status</label>
                                            <input type="checkbox" name="status"  value="{{$product->status=='1' ? 'checked':''}}" style="width: 20px;height: 20px;"  />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div>
                                    @if($product->productImages)
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <img src="{{asset($image->$image)}}" style="width: 25px;height: 25px;"
